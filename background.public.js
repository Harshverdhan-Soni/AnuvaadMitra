// ============================================================================
// === PUBLIC / PROXY BUILD — contains NO credentials. ========================
// This is the file to package for the Chrome Web Store. Do NOT paste the
// internal build's BHASHINI_* constants or its direct-Bhashini functions into
// this file. If this file ever contains a real User ID / Udyat Key, it is no
// longer safe to publish. (Rename to background.js in the public build folder.)
// ============================================================================
//
...
// shipped inside this bundle. Those credentials live ONLY on a small proxy
...
// NOTE: the C-DAC Pune endpoint takes no credentials, so the direct fallback
// below leaks nothing — it is safe to keep in the public build. (In the public
// build the proxy host is always set, so the direct branch is not exercised.)
...
// (e.g. "mera" -> मेरा/मीरा/...). Like translation, this goes through the
